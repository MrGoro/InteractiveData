package de.schuermann.interactivedata.api.data.operations.common;
 ...
 *
 * @see de.schuermann.interactivedata.api.data.operations.granularity.TimeGranularity
 * @see de.schuermann.interactivedata.api.data.operations.filter.TimeFilter
